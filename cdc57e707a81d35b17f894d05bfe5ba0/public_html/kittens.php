...
#page-container {
    ...
    flex-wrap: wrap; /* Позволяем перенос элементов на следующую строку */
    justify-content: center; /* Распределяем пространство между элементами */
    gap: 20px; /* Отступы между элементами */
}

.kitten__item {
    width: calc(30.33% - 20px); /* Устанавливаем ширину для трех элементов в строке */
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            if (isset($_SESSION["user_id"])) {
                ...
                echo "<p style='color: #A45A2A;'>"
   . "<a href='auth.php' style='color: #A45A2A; text-decoration: underline;'>Войдите</a> или "
   . "<a href='register.php' style='color: #A45A2A; text-decoration: underline;'>зарегистрируйтесь</a>, чтобы забронировать котенка."
   . "</p>";
